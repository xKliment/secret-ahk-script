; SCRIPT MODDED TO WORK FULLSCREEN AND ONLY VOICE
; All Tooltips have been disabled and replaced with voice
; if it doesn't speak install Microsoft Speech SDK. ---> https://www.microsoft.com/en-us/download/details.aspx?id=10121
; use ahkhider.
#NoEnv
...
; VOICE
rate = 3                ; 0 default, >0 to speed up, <0 to slow down
